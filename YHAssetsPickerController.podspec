Pod::Spec.new do |s|
  ...
  s.source_files 		= "CTAssetsPickerController/*.{h,m}", "CTAssetsPickerController/*/CTAssetsPickerController.strings"
  s.resources     		= "CTAssetsPickerController/CTAssetsPicker.xcassets/*/*.png"  
